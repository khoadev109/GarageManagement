...
export class CarModelPagingMapping implements ReduxMapping {
    
    mapStateToProps(state: any, ownProps?: any) : PagingProps {
        return {
            deleteResult: state.CarModelDeleteReducer,
            pagingResult: state.CarModelsWithPagingReducer
        }
    }
    
    mapDispatchToProps(dispatch: any, ownProps?: any) : PagingDispatchProps {
        const pagingAction = new FetchAction.CarModelsPagingAction();
        const deleteAction = new PostAction.CarModelDeleteAction();
