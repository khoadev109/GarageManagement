...
export class ServiceUnitPagingMapping implements ReduxMapping {
    ...
    mapDispatchToProps(dispatch: any, ownProps?: any) : PagingDispatchProps {
        const pagingAction = new FetchAction.ServiceUnitPagingAction();
        const deleteAction = new PostAction.ServiceUnitDeleteAction();
