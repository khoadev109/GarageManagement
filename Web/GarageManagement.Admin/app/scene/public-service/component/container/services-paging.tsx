        ...
        return (
            <tr className="gradeA odd" role="row" key={item.Id}>
                ...
                <td className="text-center">
                    <Anchor click={this.alertCreateOrUpdatePopup.bind(this, "dịch vụ", item.Id)}
                            content={<i className="fa fa-pencil text-navy" aria-hidden="true"/>} />
                </td>
                <td className="text-center">
                <td className="text-center"></td>
                    <Anchor click={this.alertConfirmDeletePopup.bind(this, "dịch vụ", item.Id)} 
                            ...
                            <div className="ibox-content" id="services-paging">
                                ...
                                <div className="row">
                                    ...
                                    <WrapperButton moreClass="btn-w-m" textAlign="text-right" text="Thêm mới"
                                                    click={this.alertCreateOrUpdatePopup.bind(this, "dịch vụ")} />
                                    </div>
                                </div>
                            </div>
                        </div>
