...
import { IReceipts } from "../../../../state/bill-state";
import { formatNumberWithCommaSeparator } from "../../../../../../core/library/data-type";

interface IReceiptsInfoProps {
    Information: IReceipts,
    CustomerCar: JSX.Element
}

export const ReceiptsInfo = (props: IReceiptsInfoProps) => {
    return (
        <React.Fragment>
            <div className="row">
                                ...
                                <table className="table print-page">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><strong>{props.Information.Payer}</strong></td>
                                            <td></td>
                                            <td></td>
                                        </tr>
                                        {props.CustomerCar}
            ...
            <div className="row" style={{ paddingTop: 50, paddingBottom: 200 }}>
                <div className="col-xs-4">
                    <div className="text-center">
                        <h3><strong className="text-uppercase">Người nộp tiền</strong></h3>
                    </div>
                </div>
                <div className="col-xs-4">
                    <div className="text-center">
