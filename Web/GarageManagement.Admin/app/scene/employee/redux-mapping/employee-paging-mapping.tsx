...
export class EmployeePagingMapping implements ReduxMapping {
    ...
    mapDispatchToProps(dispatch: any, ownProps?: any) : PagingDispatchProps {
        const pagingAction = new FetchAction.EmployeesPagingAction();
        const deleteAction = new PostAction.EmployeeDeleteAction();
