        ...
        return (
            <tr className="gradeA odd" role="row" key={item.Id}>
                ...
                <td className="text-center">
                    <Anchor click={this.showCreateOrUpdatePopup.bind(this, "năm sản xuất", item.Id)}
                            content={<i className="fa fa-pencil text-navy" aria-hidden="true"/>} />
                </td>
                <td className="text-center">
                    <Anchor click={this.showConfirmDeletePopup.bind(this, "năm sản xuất", item.Id)} 
                                ...
                                <div className="row">
                                    <div className="col-lg-12 text-right">
                                        <WrapperButton moreClass="btn-w-m" textAlign="text-right" text="Thêm mới"
                                                       click={this.showCreateOrUpdatePopup.bind(this, "năm sản xuất")} />
                                    </div>
                                </div>
                            </div>
                        </div>
