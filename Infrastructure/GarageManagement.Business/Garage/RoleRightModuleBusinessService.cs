...
namespace GarageManagement.Business.Garage
{
    ...
    {
        public RoleRightModuleBusinessService(IUnitOfWork<GarageDbContext> unitOfWork) : base(unitOfWork)
        { }
        ...
        public Task<DataResult<bool>> Create(RoleRightModule roleRightModule)
        {
            return Task.Run(() =>
            {
                ...
                try
                {
                    var perByUserGroup = Context.RoleRightModules.Where(x => x.ModuleId == roleRightModule.ModuleId && x.RoleId == roleRightModule.RoleId).FirstOrDefault();
                    var perByUser = Context.RoleRightModules.Where(x => x.ModuleId == roleRightModule.ModuleId && x.UserId == roleRightModule.UserId).FirstOrDefault();
                    if (roleRightModule.RoleId != null && perByUserGroup != null)
                        ...
                        Context.RoleRightModules.Add(roleRightModule);
        ...
        public Task<DataResult<List<DTORoleRightModule>>> GetByUser(int userId)
        {
            return Task.Run(() =>
            {
                ...
                try
                {
                    ...
                    if (user != null)
                    {
                        query = (from a in Context.RoleRightModules
                                 ...
                                 select new DTORoleRightModule
                                 {
                                     ...
                                     RoleId = a.RoleId,
                                     Value = a.Value,
                                     UserRights = (from c in Context.RoleRightModules
